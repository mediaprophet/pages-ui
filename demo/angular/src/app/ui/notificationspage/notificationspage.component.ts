...
import { UntypedFormBuilder, FormGroup, FormControl, Validators, ReactiveFormsModule } from '@angular/forms';
...
export class NotificationspageComponent implements OnInit {
  ...
  constructor(private fb: UntypedFormBuilder, private _notification: MessageService) {
