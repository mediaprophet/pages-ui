...
export class pgRangePickerComponent implements ControlValueAccessor, OnInit {
  ...
  @ViewChildren(pgTimePickerInnerComponent)
  timePickerInner: QueryList<pgTimePickerInnerComponent>;
  ...
  _setTriggerWidth(): void {
    this._triggerWidth =
      this.trigger.nativeElement.getBoundingClientRect().width;
  }
  ...
  reposition(): void {
    if (
      ...
      const cdkOrigin = this._cdkOverlay.origin as CdkOverlayOrigin;
      const originElement = cdkOrigin.elementRef.nativeElement;
