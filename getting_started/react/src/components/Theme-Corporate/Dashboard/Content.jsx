...
const Content = () => {
  ...
  const progress =
    <React.Fragment>
      <div className="card-progress" style={{ "backgroundColor": "rgba(0, 0, 0, 0.6)", "display": "block" }}></div>
    </React.Fragment>
            ...
            <div className="col-lg-4 col-xl-3 col-xlg-2 ">
                    ...
                    <div className="container-xs-height full-height">
                        ...
                        <div className="col-xs-height col-top">
                          <div className="card-header  top-left top-right">
                            <div className="card-title">
                              <span className="font-montserrat fs-11 all-caps">Weekly Sales </span>
                            </div>
                      ...
                      <div className="row-xs-height ">
                        <div className="col-xs-height col-top relative">
                            ...
                            <div className="col-sm-6">
                              <div className="p-l-20 full-height d-flex flex-column justify-content-between">
                                ...
                                <p className="small m-t-5 m-b-20">
                                  <span className="label label-white hint-text font-montserrat m-r-5">60%</span><span className="fs-12">Higher</span>
                                </p>
                              </div>
                            </div>
                            <div className="col-sm-6">
                          ...
                          <div className="widget-8-chart line-chart" data-line-color="white" data-points="true" data-point-color="success" data-stroke-width="2">
                            {/* START SVG HERE */}
                            <svg>
                              <g className="nvd3 nv-wrap nv-lineChart" transform="translate(-10,10)">
                                <g>
                                  <rect width="163" height="103" style={{ "opacity": "0" }}></rect>
                                  <g className="nv-x nv-axis"></g>
                                  <g className="nv-y nv-axis"></g>
                                  <g className="nv-linesWrap">
                                    <g className="nvd3 nv-wrap nv-line" transform="translate(0,0)">
                                      <defs>
                                      ...
                                      <g clipPath="">
                                        <g className="nv-groups">
                                          <g className="nv-group nv-series-0" style={{ "strokeOpacity": "1", "fillOpacity": "0.5", "fill": "rgb(0, 0, 0)", "stroke": "rgb(0, 0, 0)" }}>
                                            <path className="nv-line" d="M0,103L30.16666666666667,75.53333333333333L60.33333333333334,34.33333333333334L90.5,27.46666666666667L120.66666666666669,0L150.83333333333334,13.733333333333334L181,68.66666666666667"></path>
                                          </g>
                                        </g>
                                        <g className="nv-scatterWrap" clipPath="">
                                          <g className="nvd3 nv-wrap nv-scatter nv-chart-10456" transform="translate(0,0)">
                                            <defs>
                                              <clipPath id="nv-edge-clip-10456">
                                                <rect width="163" height="103"></rect>
                                              </clipPath>
                                            ...
                                            <g clipPath="">
                                              <g className="nv-groups">
                                                <g className="nv-group nv-series-0" style={{ "strokeOpacity": "1", "fillOpacity": "0.5", "stroke": "rgb(0, 0, 0)", "fill": "rgb(0, 0, 0)" }}>
                                                  <circle cx="0" cy="103" r="3" className="nv-point nv-point-0" style={{ "strokeWidth": "2px" }}></circle>
                                                  <circle cx="30.16666666666667" cy="75.53333333333333" r="3" className="nv-point nv-point-1" style={{ "strokeWidth": "2px" }}></circle>
                                                  <circle cx="60.33333333333334" cy="34.33333333333334" r="3" className="nv-point nv-point-2" style={{ "strokeWidth": "2px" }}></circle>
                                                  <circle cx="90.5" cy="27.46666666666667" r="3" className="nv-point nv-point-3" style={{ "strokeWidth": "2px" }}></circle>
                                                  <circle cx="120.66666666666669" cy="0" r="3" className="nv-point nv-point-4" style={{ "strokeWidth": "2px" }}></circle>
                                                  <circle cx="150.83333333333334" cy="13.733333333333334" r="3" className="nv-point nv-point-5" style={{ "strokeWidth": "2px" }}></circle>
                                                  <circle cx="181" cy="68.66666666666667" r="3" className="nv-point nv-point-6" style={{ "strokeWidth": "2px" }}></circle>
                                                </g>
                                              </g>
              ...
              <div className="row">
                <div className="col-lg-12 m-b-10">
                  ...
                  <div className="widget-9 card  bg-success no-margin widget-loader-bar text-dark">
                    <div className="full-height d-flex flex-column">
                      <div className="card-header ">
                        ...
                        <div className="card-controls">
                          <ul>
                            <li>
                              <a data-toggle="refresh" className={`card-refresh ${refreshSeven ? 'refreshing' : ''}`} href=""
                                onClick={(e) => {
                                  e.preventDefault()
                              ...
                              >
                                <i className={`card-icon card-icon-refresh ${refreshSeven ? 'fade' : ''}`}></i>
                                <i className={`card-icon-refresh-lg-white-animated ${refreshSeven ? 'active' : ''}`} style={{ "position": "absolute", "top": "14px", "right": "20px" }}></i>
                              </a>
                            </li>
                          </ul>
                        </div>
                  ...
                  <div className="widget-10 card  bg-white no-margin widget-loader-bar">
                    <div className="card-header  top-left top-right ">
                      ...
                      <div className="card-controls">
                        <ul>
                          <li>
                            <a data-toggle="refresh" className={`card-refresh ${refreshEight ? 'refreshing' : ''}`} href=""
                              onClick={(e) => {
                                e.preventDefault()
                            ...
                            >
                              <i className={`card-icon card-icon-refresh ${refreshEight ? 'fade' : ''}`}></i>
                              <i className={`card-icon-refresh-lg-white-animated ${refreshEight ? 'active' : ''}`} style={{ "position": "absolute", "top": "14px", "right": "20px" }}></i>
                            </a>
                          </li>
                        </ul>
                      </div>
                      ...
                      <div className="row">
                        <div className="col-sm-12">
                          ...
                          <div className="d-flex align-items-center pull-left small">
                            <span>WMHC</span>
                            <span className=" text-success"> <i className="pg-icon m-l-10">arrow_up</i> </span>
                            <span className="text-success font-montserrat"> 21% </span>
                          </div>
                          <div className="d-flex align-items-center pull-left m-l-20 small">
                            <span>HCRS</span>
                            <span className="text-danger"><i className="pg-icon m-l-10">arrow_down</i> </span>
                            <span className="text-danger font-montserrat"> 21% </span>
                          </div>
                  ...
                  <div className="widget-12 card  widget-loader-circle no-margin">
                        ...
                        <div className="card-header  pull-up top-right ">
                          <div className="card-controls">
                            <ul>
                              ...
                              <li>
                                <a data-toggle="refresh" className={`card-refresh ${refreshNine ? 'refreshing' : ''}`} href=""
                                  onClick={(e) => {
                                    e.preventDefault()
                                    setRefreshNine(true);
                                    setTimeout(() => {
                                ...
                                >
                                  <i className={`card-icon card-icon-refresh ${refreshNine ? 'fade' : ''}`}></i>
                                  <i className={`card-icon-refresh-lg-white-animated ${refreshNine ? 'active' : ''}`} style={{ "position": "absolute", "top": "14px", "right": "20px" }}></i>
                                </a>
                              </li>
                            </ul>
                          </div>
                    ...
                    <div className="card-body">
                      <div className="row">
                        <div className="col-lg-8">
                          <div className="p-l-5">
                            <h2 className="pull-left m-t-5 m-b-5">Tesla Inc.</h2>
                            <h2 className="pull-right m-r-25 m-t-5 m-b-5 text-success">
                              <i className="pg-icon m-r-5">arrow_up</i>
                              <span className="">448.97</span>
                              <span className="text-success fs-12">+318.24</span>
                            </h2>
                            <div className="clearfix"></div>
                            <div className="full-width">
                              <ul className="list-inline m-t-10 p-b-10 m-b-0 b-b b-dashed b-grey">
                                <li><a href="#" className="font-montserrat fs-12 text-color">1D</a>
                                </li>
                                <li className="active"><a href="#" className="font-montserrat fs-12   bg-contrast-low text-color">5D</a>
                                </li>
                                <li><a href="#" className="font-montserrat fs-12 text-color">1M</a>
                                </li>
                                <li><a href="#" className="font-montserrat fs-12 text-color">1Y</a>
                                </li>
                              </ul>
                            </div>
                        ...
                        <div className="col-sm-4 p-l-15">
                          <div className="widget-12-search">
                            ...
                            <button aria-label="" className="btn btn-default btn-rounded btn-icon pull-right">
                          ...
                          <div className="company-stat-boxes">
                            <div data-index="0" className="company-stat-box m-t-15 active p-l-5 p-r-5 p-t-10 p-b-10 b-b b-grey">
                              <div className="pull-left">
                                <p className="company-name pull-left text-uppercase bold no-margin">
                                  <span className="text-success fs-11"></span> AAPL
                                              </p>
                                <small className="hint-text m-l-10">Apple Inc.</small>
                              </div>
                              <div className="pull-right">
                                <p className="small hint-text no-margin inline">325.73</p>
                                <span className="label label-success m-l-5 inline">+ 12.09</span>
                              </div>
                              <div className="clearfix"></div>
                            </div>
                            <div data-index="1" className="company-stat-box active p-l-5 p-r-5 p-t-15 p-b-10 b-b b-grey">
                              <div className="pull-left">
                                <p className="company-name pull-left text-uppercase bold no-margin">
                                  <span className="text-success fs-11"></span> GOOG
                                              </p>
                                <small className="hint-text m-l-10">Alphabet Inc.</small>
                              </div>
                              <div className="pull-right">
                                <p className="small hint-text no-margin inline">1407.73</p>
                                <span className="label label-important m-l-5 inline">- 1.09</span>
                              </div>
                              <div className="clearfix"></div>
                            </div>
                            <div data-index="2" className="company-stat-box active p-l-5 p-r-5 p-t-15 p-b-10 b-b b-grey">
                              <div className="pull-left">
                                <p className="company-name pull-left text-uppercase bold no-margin">
                                  <span className="text-success fs-11"></span> YHOO
                                                </p>
                                <small className="hint-text m-l-10">Yahoo Inc.</small>
                              </div>
                              <div className="pull-right">
                                <p className="small hint-text no-margin inline">37.73</p>
                                <span className="label label-success m-l-5 inline">+ 0.09</span>
                              </div>
                              <div className="clearfix"></div>
                            </div>
                            <div data-index="3" className="company-stat-box active p-l-5 p-r-5 p-t-15 p-b-10 b-b b-grey">
                              <div className="pull-left">
                                <p className="company-name pull-left text-uppercase bold no-margin">
                                  <span className="text-success fs-11"></span> NKE
                                                </p>
                                <small className="hint-text m-l-10">Nike Inc.</small>
                              </div>
                              <div className="pull-right">
                                <p className="small hint-text no-margin inline">100.02</p>
                                <span className="label label-important m-l-5 inline">- 0.04</span>
                              </div>
                              <div className="clearfix"></div>
                            </div>
                            <div data-index="4" className="company-stat-box active p-l-5 p-r-5 p-t-15 p-b-10">
                              <div className="pull-left">
                                <p className="company-name pull-left text-uppercase bold no-margin">
                                  <span className="text-success fs-11"></span> TSLA
                                                </p>
                                <small className="hint-text m-l-10">Tesla Inc.</small>
                              </div>
                              <div className="pull-right">
                                <p className="small hint-text no-margin inline">537.73</p>
                                <span className="label label-success m-l-5 inline">+ 0.09</span>
                              </div>
                              <div className="clearfix"></div>
                            </div>
                          </div>
                          <span className="pull-bottom hint-text small">VIA YAHOO Finance (Stock market API)(800) MY-STOCKS (800-692-7753)</span>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div className="widget-15 card no-margin  widget-loader-circle">
                ...
                <div className="card-body no-padding">
                  <ul className="nav nav-tabs nav-tabs-simple p-t-5">
                    ...
                    <li className="nav-item"><a href="#" data-toggle="tab" className="">
                      FB<br />
                                          45.97<br />
                      ...
                      <div className="full-width">
                        <div className="full-width">
                          <div className="widget-15-chart rickshaw-chart rickshaw_graph">
                            <BarDoubleWidget 
                              style={{height: '200px', width: '100%', paddingLeft: '0px', marginLeft: '0px'}}
                              color={['#0F8EFA', '#F4F4F4']}
                            />
                          </div>
                        </div>
                  ...
                  <div className="p-t-20 p-l-20 p-r-20 p-b-20">
                    <div className="row">
                      <div className="col-md-9">
                        <p className="fs-16">Apple’s Motivation - Innovation
                      ...
                      <div className="col-md-3 text-right">
                        <p className="font-montserrat bold text-success m-r-20 fs-16 m-t-0">+0.94</p>
                    ...
                    <div className="col-xs-height">
                      <div className="card-header ">
                        ...
                        <div className="card-controls">
                          <ul>
                            <li>
                              <a data-toggle="refresh" className={`card-refresh ${refreshFourteen ? 'refreshing' : ''} text-black`} href=""
                                onClick={(e) => {
                                  e.preventDefault()
                              ...
                              >
                                <i className={`card-icon card-icon-refresh ${refreshFourteen ? 'fade' : ''}`}></i>
                                <i className={`card-icon-refresh-lg-white-animated ${refreshFourteen ? 'active' : ''}`} style={{ "position": "absolute", "top": "14px", "right": "20px" }}></i>
                              </a>
                            </li>
                          </ul>
                        </div>
                  ...
                  <div className="row-xs-height">
                    <div className="col-xs-height relative bg-contrast-lowest">
                      <div className="widget-14-chart_y_axis">
                        <svg className="rickshaw_graph y_axis" width="35" height="326.70000000000005" style={{ "position": "relative" }}><g className="y_ticks plain"><g className="tick major" transform="translate(0,296)" style={{ "opacity": "1" }}><line x2="4" y2="0"></line><text x="7" y="0" dy=".32em" style={{ "textAnchor": "start" }}>0</text></g><g className="tick major" transform="translate(0,189.08735475600236)" style={{ "opacity": "1" }}><line x2="4" y2="0"></line><text x="7" y="0" dy=".32em" style={{ "textAnchor": "start" }}>10</text></g><g className="tick major" transform="translate(0,82.17470951200474)" style={{ "opacity": "1" }}><line x2="4" y2="0"></line><text x="7" y="0" dy=".32em" style={{ "textAnchor": "start" }}>20</text></g><path className="domain" d="M4,0H0V296H4"></path></g>
                        </svg>
                      </div>
                      <ServerLoadWidget />
              ...
              <div className="widget-15-2 card no-margin  widget-loader-circle">
                <div className="card-header  top-right">
                  <div className="card-controls">
                    <ul>
                      <li>
                        <a data-toggle="refresh" className={`card-refresh ${refreshTen ? 'refreshing' : ''}`} href=""
                          onClick={(e) => {
                            e.preventDefault()
                            setRefreshTen(true);
                            setTimeout(() => {
                        ...
                        >
                          <i className={`card-icon card-icon-refresh ${refreshTen ? 'fade' : ''}`}></i>
                          <i className={`card-icon-refresh-lg-white-animated ${refreshTen ? 'active' : ''}`} style={{ "position": "absolute", "top": "14px", "right": "20px" }}></i>
                        </a>
                      </li>
                    </ul>
                  </div>
                ...
                <div className="p-t-10 p-l-20 p-r-20 p-b-20">
                  <div className="row">
                    <div className="col-md-9">
                      <p className="fs-16">Apple’s Motivation - Innovation distinguishes between A leader and a follower.</p>
                      <p className="small hint-text">VIA Apple Store (Consumer and Education Individuals)<br />(800) MY-APPLE (800-692-7753)</p>
                    </div>
                    <div className="col-md-3 text-right">
                      <h5 className="font-montserrat bold text-success m-t-0">+0.94</h5>
              ...
              <div className="widget-18 card   no-margin ">
                <div className="padding-15">
                  <div className="item-header clearfix">
                    ...
                    <div className="inline m-l-10">
                      ...
                      <p className="no-margin hint-text fs-12 d-flex">Shared a link
                        <span className="location semi-bold d-flex"><i className="pg-icon">map</i> NY center</span>
                      </p>
                    </div>
                  </div>
                </div>
                <div className="relative">
                  <ul className="buttons pull-top top-right list-inline p-r-10 p-t-10">
                    <li>
                      <a className="text-white" href="#"><i className="pg-icon">expand</i>
                      </a>
                    </li>
                    <li>
                      <a className="text-white" href="#"><i className="pg-icon">heart_outline</i>
                      </a>
                    </li>
                  </ul>
                  <div className="widget-18-post bg-black no-overflow">
                  </div>
                </div>
                <div className="padding-15">
                  <div className="hint-text pull-left fs-13">few seconds ago</div>
                  <ul className="list-inline pull-right no-margin">
                    <li><a className="text-color hint-text fs-13 d-flex" href="#"><i className="pg-icon m-r-5">comment_alt</i> 5,345</a>
                    </li>
                    <li><a className="text-color hint-text fs-13 d-flex" href="#"><i className="pg-icon m-r-5">heart</i> 23K</a>
                    </li>
                  </ul>
                  <div className="clearfix"></div>
                </div>
                  ...
                  <div className="card   no-margin">
                    ...
                    <div className="relative">
                      <ul className="buttons pull-top top-right list-inline p-r-10 p-t-10">
                        ...
                        <li>
                          <a className="text-white" href="#"><i className="pg-icon">comment</i>
                          </a>
                        </li>
                      </ul>
                  ...
                  <div className="card-header ">
                    ...
                    <div className="card-controls">
                      <ul>
                        ...
                        <li>
                          <a data-toggle="refresh" className={`card-refresh ${refreshTwelve ? 'refreshing' : ''} text-black`} href=""
                            onClick={(e) => {
                              e.preventDefault()
                          ...
                          >
                            <i className={`card-icon card-icon-refresh ${refreshTwelve ? 'fade' : ''}`}></i>
                            <i className={`card-icon-refresh-lg-white-animated ${refreshTwelve ? 'active' : ''}`} style={{ "position": "absolute", "top": "14px", "right": "20px" }}></i>
                          </a>
                        </li>
                      </ul>
                    </div>
                        ...
                        <div className="col-sm-6">
                          <div className="row m-t-10">
                            ...
                            <div className="col-lg-7">
                              ...
                              <Skycons color='black' icon='CLEAR_DAY' style={{width: '64%', height: 'auto' }}/>
                              <h4 className="text-danger bold no-margin p-l-10">32°</h4>
                              </div>
                            </div>
                          </div>
                          <h5>Feels like
                          ...
                          <div className="row m-t-10 timeslot">
                            <div className="col-2 p-t-10 text-center">
                              ...
                              <Skycons color='black' icon='PARTLY_CLOUDY_DAY' style={{width: '100%', height: 'auto' }}/>
                              <p className="text-success bold">30°C</p>
                            </div>
                            <div className="col-2 p-t-10 text-center">
                              <p className="small">14:00</p>
                              <Skycons color='black' icon='CLOUDY' style={{width: '100%', height: 'auto' }}/>
                              <p className="text-success bold">24°C</p>
                            </div>
                            <div className="col-2 p-t-10 text-center">
                              <p className="small">14:30</p>
                              <Skycons color='black' icon='RAIN' style={{width: '100%', height: 'auto' }}/>
                              <p className="text-success bold">30°C</p>
                            </div>
                            <div className="col-2 p-t-10 text-center">
                              <p className="small">15:00</p>
                              <Skycons color='black' icon='SLEET' style={{width: '100%', height: 'auto' }}/>
                              <p className="text-danger bold">30°C</p>
                            </div>
                            <div className="col-2 p-t-10 text-center">
                              <p className="small">15:30</p>
                              <Skycons color='black' icon='SNOW' style={{width: '100%', height: 'auto' }}/>
                              <p className="text-danger bold">30°C</p>
                            </div>
                            <div className="col-2 p-t-10 text-center">
                              <p className="small">16:00</p>
                              <Skycons color='black' icon='WIND' style={{width: '100%', height: 'auto' }}/>
                          ...
                          <div className="row">
                            <div className="forecast-day col-sm-6 text-center m-t-10 ">
                              <div className="bg-contrast-lowest p-b-10 p-t-10">
                                ...
                                <p className="small hint-text m-b-20">11th Augest 2020</p>
                                <Skycons color='black' icon='RAIN' style={{width: '75%', height: 'auto' }}/>
                                  ...
                                  <div className="padding-10">
                                    <div className="row">
                                      <div className="col-lg-6 text-center">
                                        ...
                                        <Skycons color='black' icon='SLEET' style={{width: '75%', height: 'auto' }}/>
                                        <p className="text-danger bold">30°C</p>
                                      </div>
                                      <div className="col-lg-6 text-center">
                                        <p className="small">Night</p>
                                        <Skycons color='black' icon='WIND' style={{width: '75%', height: 'auto' }}/>
                            ...
                            <div className="col-sm-6 text-center m-t-10 ">
                              <div className="bg-contrast-lowest p-b-10 p-t-10">
                                ...
                                <p className="small hint-text m-b-20">11th Augest 2020</p>
                                <Skycons color='black' icon='PARTLY_CLOUDY_DAY' style={{width: '75%', height: 'auto' }}/>
