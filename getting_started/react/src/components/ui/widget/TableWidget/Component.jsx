...
const Component = () => {
    return (
        <div className="widget-11 panel no-border  no-margin widget-loader-bar">
            <div className="panel-heading ">
                <div className="panel-title">Today's Table
                </div>
            ...
            <div className="widget-11-table auto-overflow">
                ...
                <tbody>
                    <tr>
                    <td className="font-montserrat all-caps fs-12">Purchase CODE #2345</td>
