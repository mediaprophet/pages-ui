    ...
    return (
        <div className="widget-3 card  bg-complete no-margin widget-loader-bar">
            <div className="card-body no-padding full-height">
                <div className="metro live-tile carousel" data-mode="carousel" data-start-now="true" data-delay="3000">
                    <Swiper {...params}>
                        <div className="slide-front tiles slide" >
                            <div className="padding-25">
                                <div className="pull-top">
                                    ...
                                    <div className="pull-right">
                                        <ul className="list-inline ">
                                            ...
                                            <li>
                                                <a href="#" className="widget-3-fav no-decoration">
                                ...
                                <div className="pull-bottom p-b-30">
                                    ...
                                    <h3 className="no-margin">Carefully
                                        <br />designed for a
                                        <br />great
                            ...
                            <div className="padding-25">
                                <div className="pull-top">
                                    ...
                                    <div className="pull-right">
                                        <ul className="list-inline ">
                                            <li>
                                                <a href="#" className="no-decoration"><i className="pg-icon">comment_alt</i>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="#" className="widget-3-fav no-decoration"><i className="pg-icon">heart_outline</i>
                                                </a>
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <div className="pull-bottom p-b-30">
                                    <p className="p-t-10 fs-12 p-b-5 hint-text">21 Jan</p>
                                    <h3 className="no-margin">A whole new
                                        <br />
