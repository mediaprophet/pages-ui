...
import SimpleLineGraph from '../SimpleLineGraphWidget/Component';
    ...
    return (
        ...
        <div className="widget-7 card  bg-success no-margin">
            <div className="card-body no-padding full-height">
                <div className="metro live-tile carousel" data-delay="3500" data-mode="carousel">
                    <Swiper {...params}>
                        <div className="slide-front tiles slide" >
                            <div className="padding-25">
                                <div className="pull-bottom padding-25 bottom-right bottom-left">
                                    <h5 className="no-margin semi-bold p-b-5">Apple Inc.</h5>
                                    <p className="no-margin hint-text text-ellipsis">NASDAQ : AAPL - NOV 018:40 AM ET</p>
                                    <h3 className="semi-bold"><i className="pg-icon">arrow_up</i> 0.15 (0.13%)</h3>
                                    <p>Open
                                ...
                                <div className="row-sm-height">
                                    <div className="col-sm-height padding-25">
                                        ...
                                        <div className="p-t-5 d-flex align-items-center">
                                            <p className="inline">+0.42% <span className="m-l-20">217.51</span>
                                            </p>
                                            <div className="inline"> <i className="pg-icon m-l-5">arrow_up</i>
                                            </div>
                                        </div>
                                        <p className="p-t-15 fs-16 hint-text ">GOOG - Google inc.</p>
                                        <div className="p-t-5 d-flex align-items-center">
                                            <p className="inline">+0.22% <span className="m-l-20">-2.28</span>
                                            </p>
                                            <div className="inline"> <i className="pg-icon m-l-5">arrow_down</i>
                                            </div>
                                        </div>
                                    </div>
                                </div>
