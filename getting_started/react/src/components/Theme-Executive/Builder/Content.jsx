...
const content = () => {
    ...
    return (
        ...
        {layoutOption[0] && <div className={`page-content-wrapper content-builder content-builder-executive full-width ${layoutOption[0] ? 'active' : ''}`} id="plainContent">
            ...
            {layoutOption[1] && <div className={`page-content-wrapper content-builder content-builder-executive-sidebar full-width ${contentOptions[1] ? 'active' : ''}`} id="plainContent">

                    <div className="secondary-sidebar secondary-sidebar-executive light" data-init="secondary-sidebar">
        ...
        <div className="inner-content full-height  p-r-20 p-l-20">
            ...
            {contentOptions[0] && <div className={`page-content-wrapper content-builder content-builder-executive full-width ${contentOptions[0] ? 'active' : ''}`} id="plainContent">
                <div className="content">
                    <PageContainer>
                        <ul className="breadcrumb p-l-0">
                            <li className="breadcrumb-item"><a href="#">Home</a></li>
            ...
            {contentOptions[1] && <div className={`page-content-wrapper content-builder content-builder-executive ${contentOptions[1] ? 'active' : ''}`} id="parallaxCoverpage">
                <div className="content">
            ...
            {contentOptions[2] && <div className={`page-content-wrapper content-builder content-builder-executive full-height ${contentOptions[2] ? 'active' : ''}`} id="fullheightParallax">
            ...
            {contentOptions[3] && <div className={`page-content-wrapper content-builder content-builder-executive full-height ${contentOptions[3] ? 'active' : ''}`} id="titleParallax">
                <div className="content">
            ...
            {contentOptions[4] && <div className={`page-content-wrapper content-builder content-builder-executive full-height ${contentOptions[4] ? 'active' : ''}`} id="columns-3-9">
                <div className="content full-height">
            ...
            {contentOptions[5] && <div className={`page-content-wrapper content-builder content-builder-executive full-height ${contentOptions[5] ? 'active' : ''}`} id="columns-9-3">
                <div className="content full-height">
                    <div className="container-fluid full-height no-padding">
                        <div className="row full-height no-margin">
            ...
            {contentOptions[6] && <div className={`page-content-wrapper content-builder content-builder-executive full-height ${contentOptions[6] ? 'active' : ''}`} id="columns-6-6">
                <div className="content full-height">
                    <div className="container-fluid full-height no-padding">
                        <div className="row full-height no-margin">
