									...
									<div className="card card-transparent">
										<div className="card-body no-padding">
											<div className="view-iframe-wrapper">
												<iframe
													className="no-border"
													src="http://pages.revox.io/dashboard/latest/html/condensed/views_push_parallax.html"
												>
											...
											<p>
												...
												<a href="https://docs.pages.revox.io/views">
													More info
												</a>
											</p>
										</div>
									...
									<div className="card card-transparent">
										<div className="card-body no-padding">
											<div className="view-iframe-wrapper">
												<iframe
													className="no-border"
													src="http://pages.revox.io/dashboard/latest/html/condensed/views_push.html"
												>
													Iframes are not supported.{" "}
												</iframe>
											</div>
									...
									<div className="card card-transparent">
										<div className="card-body no-padding">
											<div className="view-iframe-wrapper">
												<iframe
													className="no-border"
													src="http://pages.revox.io/dashboard/latest/html/condensed/views_from_top.html"
												>
													Iframes are not supported.{" "}
												</iframe>
											</div>
