...
const content = () => {
    ...
    const [contentOptions, setContentOptions] = useState([false, false, false, false, false, false, false]);

    const setLayoutOptionTwo = (shouldAdd) => {
        shouldAdd ? 
            document.body.classList.add("menu-behind", "horizontal-menu", "horizontal-app-menu" , "mac", "desktop", "js-focus-visible" ,"pace-done") 
            :   
            document.body.classList.remove("menu-behind", "horizontal-menu", "horizontal-app-menu" , "mac", "desktop", "js-focus-visible" ,"pace-done")
    }

    return (
        <React.Fragment>

        {layoutOption[0] && <div className={`page-content-wrapper content-builder content-builder-casual full-width ${layoutOption[0] ? 'active' : ''}`} id="plainContent">
                <div className="content">
                    <PageContainer>
                        <ul className="breadcrumb p-l-0">
                            <li className="breadcrumb-item"><a href="#">Home</a></li>
                            <li className="breadcrumb-item active active-casual">Plain template</li>
                        </ul>
            ...
            {layoutOption[1] && <div className={`page-content-wrapper content-builder content-builder-casual-sidebar full-width ${contentOptions[1] ? 'active' : ''}`} id="plainContent">

                    <div className="secondary-sidebar secondary-sidebar-casual light" data-init="secondary-sidebar">
                        ...
                        <li className="">
                            <a href="#">
                            <span className="icon-thumbnail">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="feather feather-award"><circle cx="12" cy="8" r="7"></circle><polyline points="8.21 13.89 7 23 12 20 17 23 15.79 13.88"></polyline></svg> 
                                </span>
            ...
            <div className="inner-content full-height  p-r-20 p-l-20">
                <div className="page-content-wrapper content-builder full-height" id="plainContent">
                 <div className="content">
            ...
            {contentOptions[0] && <div className={`page-content-wrapper content-builder content-builder-casual full-width ${contentOptions[0] ? 'active' : ''}`} id="plainContent">
                <div className="content">
                    <PageContainer>
                        <ul className="breadcrumb p-l-0">
                            <li className="breadcrumb-item"><a href="#">Home</a></li>
            ...
            {contentOptions[1] && <div className={`page-content-wrapper content-builder content-builder-casual ${contentOptions[1] ? 'active' : ''}`} id="parallaxCoverpage">
                <div className="content">
                        ...
                        <PageContainer>
                            <PageScroll>
                                <PageBreadcrumb className=" p-l-0">
                                    ...
                                    <li className="breadcrumb-item active active-casual">Typography</li>
                                </PageBreadcrumb>
            ...
            {contentOptions[2] && <div className={`page-content-wrapper content-builder content-builder-casual full-height ${contentOptions[2] ? 'active' : ''}`} id="fullheightParallax">
            ...
            {contentOptions[3] && <div className={`page-content-wrapper content-builder content-builder-casual full-height ${contentOptions[3] ? 'active' : ''}`} id="titleParallax">
                <div className="content">
                    ...
                    <PageContainer className=" demo-container">
                        <ul className="breadcrumb p-l-0">
                            ...
                            <li className="breadcrumb-item active active-casual">Parallax for page title
                            </li>
                        </ul>
                    </PageContainer>
                </div>
            ...
            {contentOptions[4] && <div className={`page-content-wrapper content-builder content-builder-casual full-height ${contentOptions[4] ? 'active' : ''}`} id="columns-3-9">
                <div className="content full-height">
            ...
            {contentOptions[5] && <div className={`page-content-wrapper content-builder content-builder-casual full-height ${contentOptions[5] ? 'active' : ''}`} id="columns-9-3">
                <div className="content full-height">
                    <div className="container-fluid full-height no-padding">
                        <div className="row full-height no-margin">
            ...
            {contentOptions[6] && <div className={`page-content-wrapper content-builder content-builder-casual full-height ${contentOptions[6] ? 'active' : ''}`} id="columns-6-6">
                <div className="content full-height">
                    <div className="container-fluid full-height no-padding">
                        <div className="row full-height no-margin">
                                    ...
                                    <ul className="p-b-50">
                                        <li className="full-width m-b-30">
                                            <Content
                                                ...
                                                onClick={() => {
                                                    setContentOptions([true, false, false, false, false, false, false])
                                        ...
                                        <li className="full-width m-b-30">
                                            <Content
                                                ...
                                                onClick={() => {
                                                    setContentOptions([false, true, false, false, false, false, false])
                                                    setLayoutOption([false, false])
                                                }}
                                            >
                                        ...
                                        <li className="full-width m-b-30">
                                            <Content
                                                ...
                                                onClick={() => {
                                                    setContentOptions([false, false, false, true, false, false, false])
                                                    setLayoutOption([false, false])
                                                }}
                                            >
                                        ...
                                        <li className="full-width m-b-30">
                                            <Content
                                                ...
                                                onClick={() => {
                                                    setContentOptions([false, false, false, false, true, false, false])
                                                    setLayoutOption([false, false])
                                                }}
                                            >
