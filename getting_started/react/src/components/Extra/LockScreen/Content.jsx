                            ...
                            <div className="d-flex justify-content-start align-items-center">
                                <div className="">
                                    <div className="thumbnail-wrapper circular d48 m-r-10 ">
                                        <img width="43" height="43" data-src-retina="/assets/img/profiles/avatar_small2x.jpg" data-src="/assets/img/profiles/avatar.jpg" alt="" src="/assets/img/profiles/avatar.jpg"/>
                                    </div>
                                </div>
                                <div className="">
                            ...
                            <form id="form-lock" role="form" action="index.html" noValidate="novalidate">
                                ...
                                <div className="row">
                                    <div className="col-md-12 sm-p-l-25 d-flex">
                                        <a href="#" className="text-black fs-14 hint-text d-flex align-items-center"><i className="pg-icon m-r-5">mail</i> <span className="hint-text">12</span></a>
                                        <a href="#" className="text-black  fs-14 hint-text m-l-30 d-flex align-items-center"><i className="pg-icon m-r-5">comment</i> <span className="hint-text">4</span></a>
                                    </div>
                                </div>
                            </form>
                        </div>
            ...
            <div className="pull-bottom full-width">
                <div className="lock-container m-b-10 clearfix row">
                    <div className="inline col-lg-2">
                        <img src="/assets/img/demo/pages_icon.png" alt="" className="m-t-5 " data-src="/assets/img/demo/pages_icon.png" data-src-retina="/assets/img/demo/pages_icon_2x.png" width="60" height="60"/>
                    </div>
