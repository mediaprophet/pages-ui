            ...
            <div className="overlayer-wrapper item-info ">
                <div className="gradient-grey p-l-20 p-r-20 p-t-20 p-b-5">
                    <div className="">
                        ...
                        <h5 className="pull-right semi-bold text-white font-montserrat bold">{price}</h5>
                    ...
                    <div className="m-t-10">
                        ...
                        <div className="pull-right m-t-10">
                            <button aria-label="" className="btn btn-white btn-xs btn-mini bold fs-14" type="button">+</button>
                        </div>
                        <div className="clearfix"></div>
                    </div>
                </div>
