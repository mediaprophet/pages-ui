				...
				<div
					className={
						path.includes("/executive") || path.includes("/casual")
							? "container-fluid   container-fixed-lg sm-p-l-0 sm-p-r-0 container"
					...
					<div className="gallery">
						<div className="gallery-filters p-t-20 p-b-10">
							<ul className="list-inline text-right">
								...
								<li>
									<a href="#" className="active text-color p-r-5 p-l-5">
										Name
									</a>
								</li>
								<li>
									<a href="#" className="text-color hint-text p-r-5 p-l-5">
										Views
									</a>
								</li>
								<li>
								...
								>
									<Swiper {...params}>
										<div className="slide-front slide">
											<img
												src="/assets/img/gallery/2_1.jpg"
												alt=""
										...
										<div className="slide-back slide">
											<img
												src="/assets/img/gallery/2_2.jpg"
												alt=""
												className="image-responsive-height res-image"
											/>
										</div>
				...
				>
					<div className="padding-40 ">
						...
						<form className="" role="form">
							...
							<div
								className="bg-danger m-b-10 noUi-target noUi-ltr noUi-horizontal noUi-background"
								id="slider-margin"
							>
								<Slider
									connect={true}
