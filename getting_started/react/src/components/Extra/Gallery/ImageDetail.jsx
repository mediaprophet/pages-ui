                    ...
                    <div className="dialog__content">
                        <div className="container-fluid">
                            <div className="row dialog__overview">
                                <div className="col-md-7 no-padding item-slideshow-wrapper full-height">
                                    <div className="item-slideshow full-height owl-carousel owl-loaded owl-drag">
                                    <Carousel>
                                        <Carousel.Item>
                                            <img
                                                className="d-block w-100"
                                                src="/assets/img/gallery/item-square.jpg"
                                                alt="square1"/>
                                        </Carousel.Item>
                                        <Carousel.Item>
                                            <img
                                        ...
                                        <div className="row row-xs-height">
                                            <div className="col-8 col-xs-height col-middle no-padding">
                                                ...
                                                <div className="inline m-l-15">
                                                    ...
                                                    <p className="hint-text text-white no-margin fs-12">Senior UI/UX designer</p>
                                                </div>
                                            </div>
                                            <div className="col-4 col-xs-height col-middle text-right  no-padding">
                                                <h2 className="bold text-white price font-montserrat">$20.00</h2>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-md-5 p-r-35 p-t-35 p-l-35 full-height item-description">
                                    <h2 className="semi-bold no-margin font-montserrat">Happy Ninja</h2>
                                    ...
                                    <p className="fs-13">
                                        ...
                                        must be introduced intentionally. Good design makes a product useful.
                                    </p>
                                    <div className="row m-b-20 m-t-20">
                                        <div className="col-6">
                                            <span className="font-montserrat all-caps fs-11">Price ranges</span>
                                        </div>
                                        <div className="col-6 text-right">$20.00 - $40.00</div>
                                    </div>
                                    <div className="row m-t-20 m-b-10">
                                        <div className="col-6">
                                            <span className="font-montserrat all-caps fs-11">Paint sizes</span>
                                        </div>
                                    </div>
                                    <button aria-label="" className="btn btn-white">S</button>
                                    <button aria-label="" className="btn btn-white">M</button>
                                    <button aria-label="" className="btn btn-white">L</button>
                                    <button aria-label="" className="btn btn-white">XL</button>
                                    <br />
                                    <button aria-label="" className="btn btn-primary buy-now">Buy Now</button>
                                </div>
                            </div>
                            <div className="row dialog__footer bg-info-dark d-sm-none d-none d-sm-flex d-lg-flex d-xl-flex">
                                ...
                                <div className="col-md-5 full-height">
                                    <ul className="recommended list-inline pull-right m-t-10 m-b-0">
                                        <li>
                                            <a href="#"><img alt="gallery" src="/assets/img/gallery/thumb-1.jpg"/></a>
                                        </li>
                                        <li>
                                            <a href="#"><img alt="gallery" src="/assets/img/gallery/thumb-2.jpg"/></a>
                                        </li>
                                        <li>
                                            <a href="#"><img alt="gallery" src="/assets/img/gallery/thumb-3.jpg"/></a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <button aria-label="" className="close action top-right" data-dialog-close=""><i className="pg-close fs-14"></i></button>
                    </div>
                </div>
            </Modal.Body>
        </Modal>
