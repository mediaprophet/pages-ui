...
const content = ({ path }) => {
	...
	return (
		<div className="page-content-wrapper ">
			...
			>
				<nav
					className="navbar navbar-default bg-white sm-padding-10 full-width p-t-0 p-b-0"
					role="navigation"
				>
										...
										<li className="nav-item">
											<a href="#" className="p-r-10">
												<img
													...
													src="/assets/img/invoice/pdf.png"
												/>
											</a>
										</li>
										<li className="nav-item">
											<a href="#" className="p-r-10">
												<img
													...
													src="/assets/img/invoice/image.png"
												/>
											</a>
										</li>
										<li className="nav-item">
											<a href="#" className="p-r-10">
												<img
													...
													src="/assets/img/invoice/doc.png"
												/>
											</a>
										</li>
										<li className="nav-item">
								...
								<div className="invoice padding-50 sm-padding-10">
									<div>
										<div className="pull-left">
											<img
												...
												data-src="/assets/img/invoice/squarespace.png"
												src="/assets/img/invoice/squarespace.png"
											/>
									...
									<div>
										<img
											...
											data-src="/assets/img/invoice/signature.png"
											src="/assets/img/invoice/signature2x.png"
										/>
