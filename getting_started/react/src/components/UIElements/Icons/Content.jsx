					...
					<PageContainer
						className={
							path.includes("/executive") || path.includes("/casual")
								? "sm-p-l-0 sm-p-r-0 full-height container"
								...
								<div className="col-md-7 col-lg-4">
									...
									<div className="m-t-20 m-b-40">
										...
										<p className="hint-text d-flex align-items-center">
											...
											<a href="" className="btn btn-icon-link hint-text m-l-5">
												<Icon>more</Icon>
											</a>
										</p>
									</div>
									...
									<div className="row">
										<div className="col-lg-11">
											...
											<img
												...
												src="../assets/img/demo/icons_hero.png"
												data-src="../assets/img/demo/icons_hero.png"
												data-src-retina="../assets/img/demo/icons_hero2x.png"
												alt=""
												width="612"
												height="69"
											/>
