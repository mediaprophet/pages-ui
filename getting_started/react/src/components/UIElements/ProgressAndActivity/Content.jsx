										...
										<div className="full-height d-flex justify-content-center align-items-center">
											<div className="card-body text-center">
												<img
													...
													src="../assets/img/demo/progress.svg"
													alt="Progress"
												/>
											</div>
										</div>
								...
								<div className="col-lg-4">
									<div className="card card-default">
										<div className="card-body text-center no-padding">
											<img
												alt="Determinate bar"
												src="../assets/img/demo/determinate_bar.gif"
											/>
										</div>
									</div>
								</div>
									...
									<div className="card card-default">
										<div className="card-body text-center no-padding">
											<img
												...
												src="../assets/img/demo/indeterminate_bar.gif"
											/>
										</div>
									</div>
								</div>
									...
									<div className="card card-default">
										<div className="card-body text-center no-padding">
											<img
												...
												src="../assets/img/demo/determinate_circle.gif"
											/>
										</div>
									</div>
								</div>
									...
									<div className="card card-default">
										<div className="card-body text-center no-padding">
											<img
												...
												src="../assets/img/demo/indeterminate_circle.gif"
											/>
										</div>
									</div>
								</div>
