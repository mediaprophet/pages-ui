			...
			>
				...
				>
					{stickUpModalSize[2] ? (
						...
						<div className="modal-content-wrapper">
							<div className="modal-content">
								<div className="p-l-25 p-r-15 p-t-15">
									<button
										aria-label=""
										type="button"
										className="close"
										...
										<div className="full-height">
											<div className="card-body text-center">
												<img
													...
													src="../assets/img/demo/modal_hero.gif"
													alt=""
												/>
											</div>
										</div>
