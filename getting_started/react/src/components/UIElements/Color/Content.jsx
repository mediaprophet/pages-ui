					...
					<PageContainer
						className={
							path.includes("/executive") || path.includes("/casual")
								? "sm-p-l-0 sm-p-r-0 p-l-0 p-r-0 container"
								...
								<div className="row m-lg-0">
									<div className="col-xl-7 col-lg-6">
										...
										<div className="full-height">
											<div className="card-body text-center justify-content-center align-items-center d-flex full-height">
												<img
													src="../assets/img/demo/color_banner.gif"
													src2x="../assets/img/demo/color_banner@2x.gif"
													src1x="../assets/img/demo/color_banner.gif"
													alt=""
													width="240"
												/>
											</div>
									...
									<div className="col-xl-5 col-lg-5 d-flex align-items-center">
										...
										<div className="card card-transparent">
											...
											<div className="card-body p-r-10 p-l-10">
												<h3 className="">
									...
									>
										<div className="padding-10">
											<div className="d-flex m-b-10">
												<div className="">
													<img
														src="../assets/img/demo/palette.png"
														alt="Pages color swatcher"
														src1x="../assets/img/demo/palette.png"
														src2x="../assets/img/demo/palette@2x.png"
														width="56"
														height="56"
													/>
												</div>
							...
							<div className="card no-border">
								...
								<div className="card-body">
									...
									<img
										...
										src="../assets/img/demo/legibility.gif"
										alt="text legibility"
										src1x="../assets/img/demo/legibility.gif"
										src2x="../assets/img/demo/legibility@2x.gif"
										width="485"
									/>
								</div>
							</div>
									...
									<div className="row">
										<div className="col-md-6">
											...
											<img
												...
												src="../assets/img/demo/color_calib.gif"
												alt="Pages color calibration"
												src1x="../assets/img/demo/color_calib.gif"
												src2x="../assets/img/demo/color_calib@2x.gif"
												width="310"
											/>
										</div>
										<div className="col-md-6">
											...
											<a href="#" className="btn btn-default m-t-30">
												See documentation
											</a>
										</div>
									</div>
