										...
										<div className="full-height">
											<div className="card-body text-center">
												<img
													...
													src="../assets/img/demo/notifications_hero.gif"
													alt=""
												/>
											</div>
										</div>
											...
											<div className="row">
												...
												<div className="col-md-6">
													<button
														aria-label=""
														type="button"
														className="btn btn-success btn-lg show-notification"
														onClick={() => {
										...
										>
											<div className="notification-positions">
												...
												>
													<img
														alt="Loading bar"
														src="../assets/img/notifications/loading_bar.svg"
														className=""
														onClick={() => {
											...
											<div className="notification-positions">
												<div className="pull-top full-width">
													...
													>
														<img
															alt="Bounce progress"
															src="../assets/img/notifications/bounce_progress.svg"
															className=""
															onClick={() => {
											...
											<div className="notification-positions">
												<div className="pull-top full-width">
													...
													>
														<img
															alt="Circle progress"
															src="../assets/img/notifications/circle_progress.svg"
															className=""
															onClick={() => {
											...
											<div className="notification-positions">
												<div className="pull-top full-width">
													...
													>
														<img
															alt="Simple alert"
															src="../assets/img/notifications/simple_alert.svg"
															className=""
															onClick={() => {
								...
								<div className="card-body">
									...
									<Alert type="info" className="d-flex">
										...
										<p className="bold no-margin">
											<a href="#" className="text-complete">
												See all now
											</a>
										</p>
										<button
